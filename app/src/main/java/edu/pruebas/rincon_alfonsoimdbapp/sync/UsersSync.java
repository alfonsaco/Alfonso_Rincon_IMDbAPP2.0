...
public class UsersSync {
    ...
    public void syncUserLogin(FirebaseUser firebaseUser) {
        ...
        // Se intenta obtener el número de teléfono de Firebase (si está disponible)
    ...
    public void syncUserDataToFirebase(String email, String direccion, String telefono, String imagen) {
        try {
